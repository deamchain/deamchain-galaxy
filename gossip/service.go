...
import (
	...
	"github.com/deamchain/deam-base/utils/workers"
	...
	"github.com/deamchain/deamchain-galaxy/ethapi"
	...
	"github.com/deamchain/deamchain-galaxy/gossip/blockproc/drivermodule"
	"github.com/deamchain/deamchain-galaxy/gossip/blockproc/eventmodule"
	"github.com/deamchain/deamchain-galaxy/gossip/blockproc/evmmodule"
	"github.com/deamchain/deamchain-galaxy/gossip/blockproc/sealmodule"
	"github.com/deamchain/deamchain-galaxy/gossip/blockproc/verwatcher"
	"github.com/deamchain/deamchain-galaxy/gossip/emitter"
	"github.com/deamchain/deamchain-galaxy/gossip/filters"
	"github.com/deamchain/deamchain-galaxy/gossip/gasprice"
	"github.com/deamchain/deamchain-galaxy/inter"
	"github.com/deamchain/deamchain-galaxy/logger"
	"github.com/deamchain/deamchain-galaxy/utils/gsignercache"
	"github.com/deamchain/deamchain-galaxy/utils/wgmutex"
	"github.com/deamchain/deamchain-galaxy/valkeystore"
...
func (s *Service) Stop() error {
	defer log.Info("deam-galaxy service stopped")
	s.verWatcher.Stop()
	close(s.done)
	s.emitter.Stop()
	s.pm.Stop()
